...
urlpatterns = [
    ...
    path('folders/<int:folder_id>/', views.folder_detail, name='folder_details'), 
    path('', LoginView.as_view(template_name='login.html'), name='root_redirect'),  # Redirect root URL to login
